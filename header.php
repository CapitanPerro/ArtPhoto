...
?>
<?php
$metaGeneratorContent = 'Theme ArtPhoto 1.4, diegoportovillanueva.com';
$meta_generator = '';
...
<div id="page" class="site">
    <a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'artphoto' ); ?></a>
    <?php if (!$hideHeader) { ?>
    <header class="u-clearfix u-header u-header" id="sec-fb31">
  <div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xl u-sheet-1">
    <?php $logo = theme_get_logo(array(
            'default_src' => "/images/bab2600186442b59219160a61ecad2847c6f6f2cd95ae7ded49c66d192d1063883f325569cba3e6049a2beadac552212056c6d4463cfd8f55e4413_1280.png",
            'default_url' => home_url('/'),
            'default_width' => '58'
        )); ?><a <?php if (is_customize_preview()) echo 'data-default-src="' . esc_url($logo['default_src']) . '" '; ?>href="<?php echo esc_url($logo['url']); ?>" class="u-image u-logo u-image-1 custom-logo-link" data-image-width="1280" data-image-height="1058">
      <img <?php if ($logo['svg']) {echo 'style="width:'.$logo['width'].'px"';} else {echo 'style="width:auto"';}?>src="<?php echo esc_url($logo['src']); ?>" class="u-logo-image u-logo-image-1" data-image-width="58.7142">
    </a>
    <?php
            ob_start();
            ?><nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1" data-position="MENU_art">
      ...
      <div class="u-custom-menu u-nav-container-collapse">
        ...
        <div class="u-black u-menu-overlay u-opacity u-opacity-70"></div>
            ...
            echo Theme_NavMenu::getMenuHtml(array(
                ...
                'theme_location' => 'MENU_art',
                'template' => $menu_template,
            )); ?>
    <h1 class="u-align-center u-custom-font u-text u-title u-text-1">ArtPhoto</h1>
  </div>
</header>
